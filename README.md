...
This repository contains both a [simulator for the Hana 1](./simulator), and a number of gatewares for the [pico-ice](https://tinyvision.ai/products/pico-ice-fpga-trainer-board).



The bootloader is a small modification of
[Mecrisp-pi](https://github.com/PythonLinks/mecrisp-pi).  [Documentation](https://mecrisp-ice.readthedocs.io/en/latest/instruction-set.html)
...
119 fewer LUTs than Mecrisp-Ice, and even fewer LUTs than the original J1a. 
The J1a is larger because it implements the stacks in
...
includes a boot loader (one BRAM initialized as a compute kernel) 
